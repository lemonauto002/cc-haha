...
export const zh: Record<TranslationKey, string> = {
  ...
  // Voice (火山 ASR/TTS)
  'voice.description': '通过火山引擎语音实现「说话输入」与「回复播报」。',
  'voice.enable': '开启语音模式',
  'voice.armedHint': '语音模式已开启 — 按空格键开始说话',
  'voice.recordingHint': '录音中 — 按空格键或点击停止',
  'voice.transcribing': '识别中…',
  'voice.enableInput': '启用语音输入',
  'voice.enableInputDesc': '在输入栏显示麦克风按钮，并用空格键开始说话。',
  'voice.apiKey': '火山 API Key',
  'voice.apiKeyPlaceholder': 'ark-...',
  'voice.asrResourceId': 'ASR 资源 ID',
  'voice.ttsResourceId': 'TTS 资源 ID',
  'voice.speaker': '说话人音色',
  'voice.autoSend': '识别后直接发送',
  'voice.autoSendDesc': '关闭后，识别文本会插入输入框供你确认后再发送。',
  'voice.ttsEnabled': '朗读回复',
  'voice.ttsEnabledDesc': '在每轮回复结束时，用 TTS 朗读助手的回答。',
  'voice.speakMode': '朗读内容',
  'voice.speakModeDesc': '朗读前会自动剔除代码块。',
  'voice.speakMode.off': '不朗读',
  'voice.speakMode.lastText': '最后一条回复（过长则截断）',
  'voice.speakMode.shortOnly': '仅短回复',
  'voice.save': '保存',
  'voice.saved': '已保存',
  'voice.test': '测试语音',
  'voice.testPhrase': '语音播报正常。',
  'voice.testOk': '播报成功。',
  'voice.testFailed': '播报失败。',
  'voice.testMissingKey': '请先填写 API Key。',
  'voice.unavailableTitle': '语音功能需要桌面端',
  'voice.unavailableBody': '语音识别与播报在桌面端运行，请在 Claude Code Haha 桌面应用中打开此页面。',
  'voice.usageHint': '提示：点击麦克风按钮开启语音模式，然后按空格键开始 / 停止录音。',
