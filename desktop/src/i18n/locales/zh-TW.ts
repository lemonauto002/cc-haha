...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.tab.voice': '語音',

  // Voice (火山 ASR/TTS)
  'voice.description': '透過火山引擎語音實現「說話輸入」與「回覆播報」。',
  'voice.enable': '開啟語音模式',
  'voice.armedHint': '語音模式已開啟 — 按空白鍵開始說話',
  'voice.recordingHint': '錄音中 — 按空白鍵或點擊停止',
  'voice.transcribing': '辨識中…',
  'voice.enableInput': '啟用語音輸入',
  'voice.enableInputDesc': '在輸入欄顯示麥克風按鈕，並用空白鍵開始說話。',
  'voice.apiKey': '火山 API Key',
  'voice.apiKeyPlaceholder': 'ark-...',
  'voice.asrResourceId': 'ASR 資源 ID',
  'voice.ttsResourceId': 'TTS 資源 ID',
  'voice.speaker': '說話人音色',
  'voice.autoSend': '辨識後直接傳送',
  'voice.autoSendDesc': '關閉後，辨識文字會插入輸入框供你確認後再傳送。',
  'voice.ttsEnabled': '朗讀回覆',
  'voice.ttsEnabledDesc': '在每輪回覆結束時，用 TTS 朗讀助手的回答。',
  'voice.speakMode': '朗讀內容',
  'voice.speakModeDesc': '朗讀前會自動剔除程式碼區塊。',
  'voice.speakMode.off': '不朗讀',
  'voice.speakMode.lastText': '最後一則回覆（過長則截斷）',
  'voice.speakMode.shortOnly': '僅短回覆',
  'voice.save': '儲存',
  'voice.saved': '已儲存',
  'voice.test': '測試語音',
  'voice.testPhrase': '語音播放正常。',
  'voice.testOk': '播放成功。',
  'voice.testFailed': '播放失敗。',
  'voice.testMissingKey': '請先填寫 API Key。',
  'voice.unavailableTitle': '語音功能需要桌面版',
  'voice.unavailableBody': '語音辨識與播放於桌面版執行，請在 Claude Code Haha 桌面應用程式中開啟此頁面。',
  'voice.usageHint': '提示：點擊麥克風按鈕開啟語音模式，然後按空白鍵開始 / 停止錄音。',
