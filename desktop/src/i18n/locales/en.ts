export const en = {
  ...
  // Voice (Volcano ASR/TTS)
  'voice.description': 'Speak to compose messages and have responses read aloud via Volcano speech.',
  'voice.enable': 'Enable voice mode',
  'voice.armedHint': 'Voice mode on — press Space to talk',
  'voice.recordingHint': 'Recording — press Space or click to stop',
  'voice.transcribing': 'Transcribing…',
  'voice.enableInput': 'Enable voice input',
  'voice.enableInputDesc': 'Show the microphone button in the composer and use Space to talk.',
  'voice.apiKey': 'Volcano API Key',
  'voice.apiKeyPlaceholder': 'ark-...',
  'voice.asrResourceId': 'ASR resource ID',
  'voice.ttsResourceId': 'TTS resource ID',
  'voice.speaker': 'Speaker voice',
  'voice.autoSend': 'Send recognized text immediately',
  'voice.autoSendDesc': 'When off, recognized text is inserted into the composer for you to review.',
  'voice.ttsEnabled': 'Read responses aloud',
  'voice.ttsEnabledDesc': 'Synthesize the assistant response via TTS when a turn ends.',
  'voice.speakMode': 'What to read aloud',
  'voice.speakModeDesc': 'Code blocks are always stripped before speaking.',
  'voice.speakMode.off': 'Never',
  'voice.speakMode.lastText': 'Last response (truncated if long)',
  'voice.speakMode.shortOnly': 'Only short responses',
  'voice.save': 'Save',
  'voice.saved': 'Saved',
  'voice.test': 'Test voice',
  'voice.testPhrase': 'Voice playback is working.',
  'voice.testOk': 'Playback succeeded.',
  'voice.testFailed': 'Playback failed.',
  'voice.testMissingKey': 'Enter the API key first.',
  'voice.unavailableTitle': 'Voice requires the desktop app',
  'voice.unavailableBody': 'Speech recognition and playback run in the desktop runtime. Open this page in the Claude Code Haha app.',
  'voice.usageHint': 'Tip: arm voice mode with the mic button, then press Space to start and stop recording.',
