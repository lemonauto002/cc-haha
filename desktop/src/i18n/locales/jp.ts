...
export const jp: Record<TranslationKey, string> = {
  ...
  'voice.description': 'Volcano 音声で「音声入力」と「読み上げ」を行います。',
  'voice.enable': '音声モードを有効化',
  'voice.armedHint': '音声モード ON — スペースキーで話す',
  'voice.recordingHint': '録音中 — スペースキーまたはクリックで停止',
  'voice.transcribing': '認識中…',
  'voice.enableInput': '音声入力を有効化',
  'voice.enableInputDesc': '入力欄にマイクボタンを表示し、スペースキーで話します。',
  'voice.apiKey': 'Volcano API Key',
  'voice.apiKeyPlaceholder': 'ark-...',
  'voice.asrResourceId': 'ASR リソース ID',
  'voice.ttsResourceId': 'TTS リソース ID',
  'voice.speaker': '話者音色',
  'voice.autoSend': '認識結果を即時送信',
  'voice.autoSendDesc': 'オフの場合、認識テキストは入力欄に挿入され、確認後に送信されます。',
  'voice.ttsEnabled': '応答を読み上げ',
  'voice.ttsEnabledDesc': 'ターン終了時にアシスタントの応答を TTS で読み上げます。',
  'voice.speakMode': '読み上げ内容',
  'voice.speakModeDesc': '読み上げ前にコードブロックは常に除去されます。',
  'voice.speakMode.off': '読み上げない',
  'voice.speakMode.lastText': '最後の応答（長い場合は切り詰め）',
  'voice.speakMode.shortOnly': '短い応答のみ',
  'voice.save': '保存',
  'voice.saved': '保存しました',
  'voice.test': '音声をテスト',
  'voice.testPhrase': '音声再生は正常です。',
  'voice.testOk': '再生に成功しました。',
  'voice.testFailed': '再生に失敗しました。',
  'voice.testMissingKey': '先に API Key を入力してください。',
  'voice.unavailableTitle': '音声機能にはデスクトップ版が必要です',
  'voice.unavailableBody': '音声認識と再生はデスクトップ版で動作します。Claude Code Haha アプリでこのページを開いてください。',
  'voice.usageHint': 'ヒント: マイクボタンで音声モードを有効化し、スペースキーで録音を開始 / 停止します。',
