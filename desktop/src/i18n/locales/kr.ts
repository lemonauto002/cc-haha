...
export const kr: Record<TranslationKey, string> = {
  ...
  'voice.description': 'Volcano 음성으로 “음성 입력”과 “응답 읽기”를 사용합니다.',
  'voice.enable': '음성 모드 활성화',
  'voice.armedHint': '음성 모드 켜짐 — 스페이스 키로 말하기',
  'voice.recordingHint': '녹음 중 — 스페이스 키 또는 클릭으로 중지',
  'voice.transcribing': '인식 중…',
  'voice.enableInput': '음성 입력 활성화',
  'voice.enableInputDesc': '입력창에 마이크 버튼을 표시하고 스페이스 키로 말합니다.',
  'voice.apiKey': 'Volcano API Key',
  'voice.apiKeyPlaceholder': 'ark-...',
  'voice.asrResourceId': 'ASR 리소스 ID',
  'voice.ttsResourceId': 'TTS 리소스 ID',
  'voice.speaker': '화자 음색',
  'voice.autoSend': '인식 결과 즉시 전송',
  'voice.autoSendDesc': '끄면 인식된 텍스트가 입력창에 삽입되어 확인 후 전송됩니다.',
  'voice.ttsEnabled': '응답 읽어주기',
  'voice.ttsEnabledDesc': '턴이 끝나면 어시스턴트 응답을 TTS로 읽어줍니다.',
  'voice.speakMode': '읽을 내용',
  'voice.speakModeDesc': '읽기 전에 코드 블록은 항상 제거됩니다.',
  'voice.speakMode.off': '읽지 않기',
  'voice.speakMode.lastText': '마지막 응답(길면 잘라냄)',
  'voice.speakMode.shortOnly': '짧은 응답만',
  'voice.save': '저장',
  'voice.saved': '저장됨',
  'voice.test': '음성 테스트',
  'voice.testPhrase': '음성 재생이 정상입니다.',
  'voice.testOk': '재생 성공.',
  'voice.testFailed': '재생 실패.',
  'voice.testMissingKey': '먼저 API Key를 입력하세요.',
  'voice.unavailableTitle': '음성 기능은 데스크톱 앱이 필요합니다',
  'voice.unavailableBody': '음성 인식과 재생은 데스크톱에서 실행됩니다. Claude Code Haha 앱에서 이 페이지를 여세요.',
  'voice.usageHint': '팁: 마이크 버튼으로 음성 모드를 켜고, 스페이스 키로 녹음을 시작/중지하세요.',
